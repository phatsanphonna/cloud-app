        ...
        <UserProvider>
          <AuroraBackground className="min-h-screen !h-auto items-stretch justify-start">
            <div className="relative z-10 flex min-h-screen w-full flex-col">
              <header className="sticky top-0 z-20 w-full border-b border-white/30 bg-white/70 py-3 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:border-white/10 dark:bg-zinc-900/70">
                <ContentWrapper>
                  <Navbar />
                </ContentWrapper>
              </header>
              <main className="flex-1 w-full py-6 pb-12">
